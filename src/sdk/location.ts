...
export class Location {
    ...
    async getLocationById(
        ...
        const res: operations.GetLocationByIdResponse = new operations.GetLocationByIdResponse({
    ...
    async postLocation(
        req: shared.Location,
        config?: AxiosRequestConfig
    ): Promise<operations.PostLocationResponse> {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new shared.Location(req);
        }
        ...
        const res: operations.PostLocationResponse = new operations.PostLocationResponse({
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
        });
